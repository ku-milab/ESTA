...
class ESTANetwork(nn.Module):
    def __init__(self, roi, hidden_dim, spa_hidden_dim, time, num_classes, dropout=0.2):
        super(ESTANetwork, self).__init__()

        self.temporal_model = temporal_attention(roi, hidden_dim)
        self.spatial_model = spatial_attention(time, hidden_dim, spa_hidden_dim)
